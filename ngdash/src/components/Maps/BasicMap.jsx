...
const BasicMap = () => {
    ...
    // setselectedEmployee(selectedEmployee);
    // console.log("Got the location: ",selectedEmployee);
    ...
    document.querySelectorAll(".mapboxgl-popup .mapboxgl-popup-content .rounded-md").forEach((element)=>{
      ...
      console.log("popup",element.getAttribute('data-lat'), element.getAttribute('data-lng'));
      // element.style.replace("transform: translate(-100%, -50%) translate(248px, 518px)","/*transform: translate(-100%, -50%) translate(248px, 518px)*/");
    });
                        ...
                        <div id={user.id} key={user.id}>
                           {
...

                            {
                                ...
                                //     <div className='rounded-md p-1 m-0 box-shadow-xl drop-shadow-xl bg-slate-600' data-lat={user.address.coordinates.lat} data-lng={user.address.coordinates.lng}>
